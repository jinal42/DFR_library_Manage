    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('student', 'Student'), ('librarian', 'Librarian')], max_length=30, verbose_name='user_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('return_date', models.DateField(default=api.models.expiry)),
                ('actual_return_date', models.DateField(blank=True, null=True)),
                ('fine', models.IntegerField(default=0)),
                ('book_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.book')),
